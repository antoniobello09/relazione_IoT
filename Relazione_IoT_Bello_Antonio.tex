...
\makeatletter
\renewcommand{\ALG@name}{Algoritmo} % Cambia "Algorithm" in "Algoritmo"
\makeatother
...
\input{capitolo1_introduzione}
\input{capitolo2_analisi_requisiti}
\input{capitolo3_stato_arte}
\input{capitolo4_tecnologie}
\input{capitolo5_soluzione_proposta}
\input{capitolo6_validazione}
\input{capitolo7_conclusioni}
\newpage
\printbibliography
