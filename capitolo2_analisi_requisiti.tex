...
Il sistema deve consentire l'autenticazione mediante credenziali protette. A ogni utente viene assegnato un ruolo tra amministratore, cliente e tecnico. L'accesso alle funzionalità della piattaforma deve essere regolato in base a tale ruolo.
